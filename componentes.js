            ...
            <div class="menu-card">
                ...
                <div class="nav-grid">
                    ...
                    <div class="nav-col">
                        ...
                        <a href="${rutaBase}estudios/el-bautismo-biblico.html" class="nav-link-full" data-path="el-bautismo-biblico.html">XXI. La Mayordomía y el Trabajo</a>
...
// --- 11. MOTOR DE SEO DINÁMICO (SISTEMA DE INDEXACIÓN) ---
    ...
    const calcularTiempoLectura = () => {
        ...
        const tiempo = Math.ceil(palabras / 20); // Promedio de 200 ppm
        
        const h1 = document.querySelector('h2');
        if (h1 && tiempo > 0 && !document.getElementById('lectura-estimada')) {
            const span = document.createElement('span');
            span.id = 'lectura-estimada';
            span.style.cssText = "display:block; font-family:'Montserrat', sans-serif; font-size:0.65rem;margin-bottom: 30px;color:#c5af86; margin-top:12px; letter-spacing:2px; font-weight:500; text-transform:uppercase;";
...
const inyectarEnlacesReferencia = () => {
    ...
    // Convertimos la URL a minúsculas para evitar fallos de detección
    const urlActual = window.location.pathname.toLowerCase();
    let enlacesHTML = '';

    // 2. DETECTOR DINÁMICO: Evaluamos en qué tratado está el estudiante realmente
    if (urlActual.includes('aprender-a-descansar')) {
        // Enlaces específicos para: Aprender a descansar
        enlacesHTML = `
            ...
            <a href="/estudios/mi-amistad-con-dios.html" class="link-referencia-item">
                <span class="ref-catego">PNEUMATOLOGÍA:</span> Mi amistad con Dios (Comunión) <span>→</span>
            </a>
        `;
    } else if (urlActual.includes('nuestro-dios-trino')) {
        // Enlaces específicos para: Nuestro Dios Trino
        enlacesHTML = `
            <a href="/estudios/solo-la-biblia-basta.html" class="link-referencia-item">
            ...
            <a href="/estudios/el-dios-justo-y-amoroso.html" class="link-referencia-item">
                <span class="ref-catego">TEOLOGÍA PROPIA:</span> El Dios justo y amoroso <span>→</span>
            </a>
        `;
    } else if (urlActual.includes('el-problema-del-pecado') || urlActual.includes('de-donde-viene-el-mal') || urlActual.includes('un-mundo-roto')) {
        // Enlaces específicos para la tríada de la Caída y el Pecado
        enlacesHTML = `
            ...
            <a href="/estudios/volver-a-dios.html" class="link-referencia-item">
                <span class="ref-catego">SOTERIOLOGÍA:</span> Volver a Dios (Conversión) <span>→</span>
            </a>
        `;
    } else if (urlActual.includes('como-nos-habla-dios') || urlActual.includes('solo-la-biblia-basta')) {
        // Enlaces específicos para los Prolegómenos de la fe
        enlacesHTML = `
            <a href="/estudios/la-armonia-de-los-evangelios.html" class="link-referencia-item">
                <span class="ref-catego">BIBLIOLOGÍA:</span> La Armonía de los Evangelios <span>→</span>
            </a>
            <a href="/estudios/conocer-para-amar.html" class="link-referencia-item">
                <span class="ref-catego">TEOLOGÍA PROPIA:</span> Conocer para amar <span>→</span>
            </a>
        ...
        // 3. ENLACES POR DEFECTO: Si creas un tratado nuevo y aún no lo has mapeado arriba, saldrán estos 3 básicos
        enlacesHTML = `
            <a href="/estudios/como-nos-habla-dios.html" class="link-referencia-item">
            ...
            <a href="/estudios/el-problema-del-pecado.html" class="link-referencia-item">
                <span class="ref-catego">HAMARTIOLOGÍA:</span> El problema del pecado <span>→</span>
            </a>
        `;
    }

    // 4. Construcción del contenedor HTML en la página
    ...
    // --- ESTILOS VISUALES EN JS (Permanecen idénticos y estables) ---
    ...
    Object.assign(cajaRigor.style, {
        backgroundColor: '#faf7f0', borderLeft: '3px solid #9b804e', padding: '24px', margin: '30px 0',
        display: 'flex', gap: '20px', alignItems: 'flex-start', borderRadius: '0 4px 4px 0'
    });

    const icono = contenedorRef.querySelector('.icono-balanza');
    if (icono) { icono.style.fontSize = '24px'; icono.style.color = '#9b804e'; icono.style.lineHeight = '1'; }
    ...
    Object.assign(tituloRigor.style, {
        ...
        letterSpacing: '1.5px', fontWeight: '700', color: '#9b804e', marginBottom: '8px'
    });

    const textoRigor = contenedorRef.querySelector('.texto-rigor');
    Object.assign(textoRigor.style, { fontStyle: 'italic', fontSize: '14px', lineHeight: '1.6', color: '#4a4a4a', margin: '0' });
    ...
    itemsLinks.forEach(link => {
        Object.assign(link.style, {
            ...
            fontSize: '13px', fontFamily: "var(--font-serif, 'Georgia', serif)", transition: 'all 0.3s ease'
        });
